#Queda añadir el apartado de satélites y tiempos
#Satelite recomiendo G10 y MADRID
#Hacerlo para doble frecuencia
import os
...
frecuencias = ['L1','L2']
#Revisar los que hay de satelites y realizar la implementacion
...
def leer_contenido_archivo(archivo):
    with open(archivo, 'r') as f:
        ...
        # contenido = f.readlines()  # Lee el contenido del archivo línea por línea y lo guarda en una lista de cadenas
    return contenido
